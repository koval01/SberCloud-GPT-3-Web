...
function format_result(start_, list_) {
  ...
  for (let i = 0; i < list_.length; i++) {
    result_list.push("<figure class=\"border-bottom\" onclick=\"select_story(this)\"><blockquote class=\"blockquote\"><b>"+start_+"</b><i>"+list_[i]+"</i></blockquote><figcaption class=\"blockquote-footer\">koval01.github.io/q_web</figcaption></figure>");
  }
  return result_list;
}
